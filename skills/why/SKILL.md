...
Before spawning investigators, list the available MCP tools in the environment. In Claude Code, check the connected MCP servers in the tool list and use ToolSearch to discover deferred MCP tools.
